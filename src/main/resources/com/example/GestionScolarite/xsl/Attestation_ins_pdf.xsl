            ...
            <fo:page-sequence master-reference="simpleA4">
                <fo:flow flow-name="xsl-region-body">
                    <fo:block-container text-align="center">
                        ...
                        <fo:block text-align="left" font-size="11px" space-before="5mm" space-after="5mm">
                            Est inscrit(e) à l'École Nationale des Sciences Appliquées de Tanger pour l'année universitaire 2024/2025
                        </fo:block>
                        ...
                        <fo:block text-align="left" font-size="11px" space-before="5mm" space-after="5mm">
                            <fo:inline text-decoration="underline">Année</fo:inline> : 4 ème année ( 2ème année du Cycle d'Ingénieur )
                        </fo:block>
                        ...
                        <fo:block space-before="1cm" font-size="10px">
                        ...
                        <fo:block font-size="10px" display-align="center" space-after="5mm">
                            Adresse: Ecole Nationale des Sciences Appliquées de Tanger BP 1818 - 90000s
                        </fo:block>
                        <fo:block font-size="10px" display-align="center" space-after="5mm">
                            Contact : info@ensat.ac.ma
                        </fo:block>
                    </fo:block-container>
                </fo:flow>
            </fo:page-sequence>
